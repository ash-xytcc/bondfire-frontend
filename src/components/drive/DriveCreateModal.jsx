        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(136px, 1fr))", gap: 10 }}>
          {actions.map((action) => (
            <button
              ...
              style={{ display: "grid", gap: 8, alignContent: "start", minHeight: 104, padding: 12, borderRadius: 12, border: "1px solid rgba(255,255,255,0.14)", background: dpg ? "rgba(95,148,221,0.08)" : "rgba(255,255,255,0.03)", color: dpg ? "#182018" : "#fff", textAlign: "left", cursor: "pointer" }}
            >
