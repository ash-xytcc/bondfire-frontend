...
export async function onRequestPost({ env, request, params }) {
  ...
  const result = await transitionEmergency({ env, orgId, userId: fresh.user.sub, from: ['normal', 'lockdown', 'isolated', 'prepared'],
    stage: 'normal', summary: 'Organization emergency restrictions lifted; normal access restored' });
