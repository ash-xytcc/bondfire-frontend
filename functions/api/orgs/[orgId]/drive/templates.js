...
import { ensureDriveSchema, getDb, created, json, now, uuid, bad } from "../../../_lib/drive.js";
...
export async function onRequestPost({ env, request, params }) {
  ...
  return created("template",{id,name:"encrypted template",title:"encrypted template",body:"",encryptedBlob,createdAt:t,updatedAt:t});
}
