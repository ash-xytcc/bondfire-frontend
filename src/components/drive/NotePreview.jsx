...
export default function NotePreview({ content, onOpenLink, focusMode, onUpdateProperty, onAddProperty, onRemoveProperty, propertiesCollapsed, onToggleProperties, onToggleTask }) {
  ...
  return (
    ...
    }} style={{ maxWidth: 920, margin: "0 auto", background: dpg ? "#fff" : "rgba(255,255,255,0.02)", border: dpg ? "1px solid rgba(56,80,50,0.12)" : "1px solid #1f1f1f", color: dpg ? "#182018" : "#f5f5f5", borderRadius: 10, padding: focusMode ? 12 : 10, minHeight: focusMode ? "84vh" : "72vh" }}>
